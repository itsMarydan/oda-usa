        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              <a href="/about" className="card p-6 hover:scale-105 transition-transform text-center">
              ...
              <a href="/membership" className="card p-6 hover:scale-105 transition-transform text-center">
                <h3 className="font-semibold text-oda-brown mb-2">Join ODA-USA</h3>
                <p className="text-sm text-gray-600">Become a member</p>
              </a>
              <a href="/donate" className="card p-6 hover:scale-105 transition-transform text-center">
              ...
              <a href="/events" className="card p-6 hover:scale-105 transition-transform text-center">
