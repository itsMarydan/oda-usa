                ...
                <div className={`grid lg:grid-cols-2 gap-12 items-start`}>
                  ...
                  <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                    <div className="sticky top-24">
                      <div className="relative bg-gray-200 rounded-xl overflow-hidden aspect-[4/3] flex items-center justify-center">
                        {project.images?.[0] ? (
                          <Image
                          ...
                          <div className="text-center p-8">
                            ...
                            <div className="text-sm text-gray-500 mt-1">Upload an image in Studio</div>
                          </div>
                        )}
                      </div>
                    </div>
